...
namespace SimpleBlobApi.Auth
{
    ...
    public sealed class ApplicationUserRepository : IUserRepository<ApplicationUser>
    {
        ...
        private async Task<UserWithRoles<ApplicationUser>> GetUserWithRolesAsync(
        ...
        /// <param name="userName">The user name.</param>
        /// <param name="roles">The roles.</param>
        public async Task RemoveUserFromRolesAsync(string userName,
            IList<string> roles)
        {
            if (userName == null) throw new ArgumentNullException(nameof(userName));
            if (roles == null) throw new ArgumentNullException(nameof(roles));
