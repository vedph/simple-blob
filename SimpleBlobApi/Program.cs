...
public static class Program
{
    ...
    public static async Task<int> Main(string[] args)
    {
        Log.Logger = new LoggerConfiguration()
            ...
            .WriteTo.Console()
#if DEBUG
            .WriteTo.File("simple-blob-api-log.txt", rollingInterval: RollingInterval.Day)
#endif
            .CreateLogger();

        try
        {
            Log.Information("Starting Simple BLOB API host");
            DumpEnvironmentVars();
        ...
        {
            Log.Fatal(ex, "Simple BLOB API host terminated unexpectedly");
